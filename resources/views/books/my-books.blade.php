...
<div id="subheader" class="all-books" style="background-image: url(/uploads/user_books-bg.jpg);">
	<div class="bg-gradient"></div>
	<div class="logo">
		<h1>My Books</h1>
		<p>Below is a list view of all Bookipedia Summaries that you have contributed!</p>
	</div>
</div>
