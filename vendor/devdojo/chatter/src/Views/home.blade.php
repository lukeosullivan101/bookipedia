	    ...
	    <div class="row">
	    	...
	    	<div class="col-md-4 left-column">
	    		...
	    		<div class="chatter_sidebar">
					<button class="btn btn-primary" id="new_discussion_btn" style="color:#fff;"><i class="chatter-new"></i> NEW DISCUSSION</button> 
					<a id="all_discussions" href="/{{ Config::get('chatter.routes.home') }}"><i class="chatter-bubble"></i> All {{ Config::get('chatter.titles.discussion') }}s</a>
					        		...
					        		<div class="chatter_avatar">
					        			...
					        			@else
					        				...
					        				<span class="chatter_avatar_circle">
					        					<img class= "comment-profile" src="/uploads/avatars/{{ $discussion->user->avatar }}">
